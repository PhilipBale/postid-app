...
-(void)composeInterface {
    ...
    if ( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad )
    {
        ...
        topBarSize        = CGSizeMake(self.frame.size.width, self.frame.size.height * 0.06 + 20);
    ...
    } else
    {
        ...
        topBarSize        = CGSizeMake(self.frame.size.width, [[UIScreen mainScreen] bounds].size.height * 0.07 + 20);
    ...
    if (_captureManager) {
        ...
        [_cameraShutter setBackgroundImage:[UIImage imageNamed:@"camera_button"] forState:UIControlStateNormal];
    ...
    if (_topBarView) {
        ...
        if (_cameraFlash) {
            ...
            _cameraFlash.center = CGPointMake(_topBarView.center.x * 0.80, _topBarView.center.y + 10);
        ...
        if (_cameraToggle) {
            ...
            _cameraToggle.center = CGPointMake(_topBarView.center.x * 1.20, _topBarView.center.y + 10);
        ...
        if (_cameraDismiss) {
            ...
            _cameraDismiss.center = CGPointMake(20, _topBarView.center.y + 10);
